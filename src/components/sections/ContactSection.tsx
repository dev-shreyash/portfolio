...
export default function ContactSection() {
  ...
  return (
    <main
      id="contact"
      ref={container}
      className="w-full max-w-7xl mx-auto px-4 pt-16 pb-20 bg-transparent text-gray-300 font-mono relative z-10"
    >
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="contact-card md:col-span-2 md:row-span-2 p-8 border border-neutral-800 rounded-2xl bg-black/40 backdrop-blur-md hover:border-neutral-600 transition-all flex flex-col justify-between">
          <div>
            <h2 className="text-white text-xl font-bold font-sans mb-6">
              Send a Message
            </h2>
            <form
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  <label
                    htmlFor="name"
                    className="text-xs text-neutral-500 uppercase tracking-wider font-bold"
                  >
                    Name
                  </label>
                  <input
                    ...
                    id="name"
                    name="name"
                    placeholder="Elon Tusk with billy goats"
                    className="w-full bg-neutral-900/50 border border-neutral-800 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-white transition-colors placeholder:text-neutral-700"
                  />
                </div>
                <div className="flex flex-col gap-2">
                  <label
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <textarea
                  ...
                  name="message"
                  rows={6}
                  placeholder="Hello Shreyash, I'd like to talk about..."
                  className="w-full bg-neutral-900/50 border border-neutral-800 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-white transition-colors resize-none placeholder:text-neutral-700"
                ></textarea>
              </div>
              ...
              >
                ...
                {status === "error" && (
                  <span className="text-sm">Error! Try Again</span>
                )}
              </button>
            </form>
          </div>
      ...
      {/* 2. Direct Reach (Spans 1 Column, 1 Row) */}
        <div className="contact-card md:col-span-1 p-8 border border-neutral-800 rounded-2xl bg-black/40 backdrop-blur-md hover:border-neutral-600 transition-all flex flex-col justify-center">
          <h2 className="text-white text-xl font-bold font-sans mb-6 border-b border-neutral-800 pb-4">
            Direct
          </h2>
        ...
        <div className="contact-card md:col-span-1 p-8 border border-neutral-800 rounded-2xl bg-black/40 backdrop-blur-md hover:border-neutral-600 transition-all flex flex-col justify-center">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="flex-1 h-14 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center hover:bg-white hover:border-white transition-all group"
            >
